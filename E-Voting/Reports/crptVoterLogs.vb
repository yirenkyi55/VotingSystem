...
Public Class crptVoterLogs
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "E_Voting.crptVoterLogs.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrptVoterLogs
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crptVoterLogs = New crptVoterLogs()
        rpt.Site = Me.Site
        Return rpt
    End Function
